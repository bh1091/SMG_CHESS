...
public class GlickoRating {
  ...
  public static double newRD(double rating, double RD, double oppRD, double oppRating, int t) {
  ...
  public static double newRating(double plRating, double plRD, double opRating, 
      double opRD, double s, int t) {
    double r0 = plRating;
